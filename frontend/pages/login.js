...
export default function Login({ login }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        const route = roleRoutes[data.data.userType] || '/creator-dashboard';
        router.push(route);
      } else {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <Head>
        <title>Login | Rave</title>
        <meta name="description" content="Login to your Rave account" />
      </Head>

      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex justify-center">
          <span className="text-4xl font-bold tracking-wide">RAVE</span>
        </div>
